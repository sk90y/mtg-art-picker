...
5. Selecting Artwork
Use ← / → or click a thumbnail to browse printings.

When you see the art you want, press ↓ (Down arrow) – this selects that printing and automatically moves to the next card.

The card in the left list will show a ✅ with the set and collector number.

If you change your mind later, revisit the card, pick another printing, and press ↓ again – it overwrites the selection.
